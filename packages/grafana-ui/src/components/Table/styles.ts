  ...
  const buildCellContainerStyle = (
    ...
    return css({
      ...
      '&:hover': {
        ...
        width: stringShouldWrap ? ' auto' : 'auto !important',
        height: stringShouldWrap ? 'auto' : `${rowHeight - 1}px`,
        minHeight: `${rowHeight - 1}px`,
        wordBreak: overflowOnHover && asCellText && stringShouldWrap ? 'break-word' : undefined,
