...
require (
	...
	sigs.k8s.io/structured-merge-diff/v4 v4.4.1 // indirect; @grafana-app-platform-squad
...
require (
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20240223201543-e5a26a3f7c21 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240223201543-e5a26a3f7c21 // @grafana/grafana-app-platform-squad
)
